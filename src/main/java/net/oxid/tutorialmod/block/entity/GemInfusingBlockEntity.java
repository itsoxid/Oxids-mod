...
import net.oxid.tutorialmod.recipe.GemInfusingRecipe;
import net.oxid.tutorialmod.screen.GemInfusingScreenHandler;
...
public class GemInfusingBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public boolean canInsert(int slot, ItemStack stack, @Nullable Direction side) {
        Direction localDir = this.getWorld().getBlockState(this.pos).get(GemInfusionStationBlock.FACING);
