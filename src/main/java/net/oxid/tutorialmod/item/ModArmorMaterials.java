...
public enum ModArmorMaterials implements ArmorMaterial {
    DIVINIUM("divinium", 37, new int[]{4, 7, 9, 4}, 16,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3.2f, 0.2f, () -> Ingredient.ofItems(ModItems.DIVINIUM));


    //new int goes from bottom to top for protection values boots,legs,chestplate,helmet
